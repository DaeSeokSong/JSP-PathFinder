...
<body>
	<%
		...
		if(userID != null) {
			...
			session.setAttribute("messageContent", "현제 로그인 되어있는 상태입니다.");
			...
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td colspan="2"><input class="form-control" type="email" id="userEmail" name="userEmail" maxlength="50" placeholder="이메일을 입력해주세요."></td>
					</tr>
					<tr>
