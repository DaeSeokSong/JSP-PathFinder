...
<body>
	...
	<div class="container">
		<form method="post" action="./communityReply" enctype="multipart/form-data">
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				<thead>
					<tr>
						<th colspan="3"><h4>답변 양식</h4>
					</tr>
				</thead>
				<tbody>
					<tr>
					...
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50"
							name="comTitle" placeholder="글 제목을 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5>
						<td><textarea class="form-control" rows="10" name="comContent" maxlength="2048" placeholder="글 내용을 입력하세요."></textarea></td>
					</tr>
					<tr>
