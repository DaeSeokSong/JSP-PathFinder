...
<html>
	<%
		...
		ArrayList<CommunityDTO> communityList = new CommunityDAO().getList(pageNumber);
	%>
<head>
...
<body>
	...
	<div class="container">
		<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
			<thead>
				<tr>
					<th colspan="5"><h4>커뮤니티 게시판</h4></th>
				</tr>
				<tr>
			...
			<tbody>
				<%
					for (int i = 0; i < communityList.size(); i++) {
						CommunityDTO com = communityList.get(i);
				%>
				<tr>
					<td><%=com.getComLang()%></td>
					<td style="text-align: left;"><a href="communityShow.jsp?comID=<%=com.getComID()%>">
				<%
					for(int j = 0; j < com.getComLevel(); j++) {
				%>
				...
				<tr>
					<td colspan="5">
						<a href="communityWrite.jsp" class="btn btn-primary pull-right" type="submit">글쓰기</a>
						<ul class="pagination" style="margin: 0 auto;">
						<%
							int startPage = (Integer.parseInt(pageNumber) / 10) * 10 + 1;
							if(Integer.parseInt(pageNumber) % 10 == 0) startPage -= 10;
							
							int targetPage = new CommunityDAO().targetPage(pageNumber);
							
							if(startPage != 1) {
						%>
							<li><a href="community.jsp?pageNumber=<%= startPage - 10 %>"><span class="glyphicon glyphicon-chevron-left"></span></a></li>
						<%
							} else {
						%>
						...
						%>
							<li><a href="community.jsp?pageNumber=<%= i %>"><%= i %></a></li>
						<%
							}
						%>
							<li class="active"><a href="community.jsp?pageNumber=<%= pageNumber %>"><%= pageNumber %></a></li>
						<%
						...
						%>
							<li><a href="community.jsp?pageNumber=<%= startPage + 10 %>"><span class="glyphicon glyphicon-chevron-right"></span></a></li>
						<%
							} else {
						%>
