...
<body>
	...
	<div class="container">
		<form method="post" action="./tipUpdate" enctype="multipart/form-data">
			<table class="table table-bordered table-hover" style="text-align: center; border: 1px solid #dddddd">
				...
				<tbody>
					...
					<tr>
						...
						<td>
							<select name="tipLang">
								<option value="팁" <% if(tip.getTipLang().equals("팁")) out.print("selected"); %>>팁</option>
								<option value="프로젝트" <% if(tip.getTipLang().equals("프로젝트")) out.print("selected"); %>>프로젝트</option>
								<option value="강사 후기" <% if(tip.getTipLang().equals("강사 후기")) out.print("selected"); %>>강사 후기</option>
							</select>
						</td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>글 제목</h5>
						<td><input class="form-control" type="text" maxlength="50" name="tipTitle" placeholder="글 제목을 입력하세요." value="<%= tip.getTipTitle() %>"></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5>
						<td><textarea class="form-control" rows="10" name="tipContent" maxlength="2048" placeholder="글 내용을 입력하세요."><%= tip.getTipContent() %></textarea></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>파일 업로드</h5>
						<td colspan="2">
							<input type="file" name="TipFile" class="file">
							<div class="input-group col-xs-12">
								<span class="input-group-addon"><i class="glyphicon glyphicon-file"></i></span>
								<input type="text" class="form-control input-lg" disabled placeholder="<%= tip.getTipFile() %>">
