...
@WebServlet("/TipReplyServlet")
public class TipReplyServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.sendRedirect("acatipReply.jsp");
			return;
		}
		...
		TipDTO parent = tipDAO.getTip(tipID);
		tipDAO.replyUpdate(parent);
		tipDAO.reply(userID, tipLang, tipTitle, tipContent, tipFile, tipRealFile, parent);
