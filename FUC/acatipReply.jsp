...
<body>
	...
	<div class="container">
		<form method="post" action="./tipReply" enctype="multipart/form-data">
					...
					<tr>
						...
						<td>
							<select name="tipLang">
								...
								<option value="강사 후기">강사 후기</option>
							</select>
						</td>
					</tr>
					<tr>
						...
						<td><input class="form-control" type="text" maxlength="50"
							name="tipTitle" placeholder="글 제목을 입력하세요."></td>
					</tr>
					<tr>
						<td style="width: 110px;"><h5>글 내용</h5>
						<td><textarea class="form-control" rows="10" name="tipContent" maxlength="2048" placeholder="글 내용을 입력하세요."></textarea></td>
					</tr>
					<tr>
