...
<html>
	<%
		...
		if(request.getParameter("comID") != null) {
			comID = (String)request.getParameter("comID");
		}
			...
			<tbody>
				<tr>
					<td colspan="5" style="text-align: right;">
						...
						<a href="communityReply.jsp?comID=<%= com.getComID() %>" class="btn btn-primary">답변</a>
						<%
							if(userID != null && userID.equals(com.getUserID())) {
						%>
							<a href="communityUpdate.jsp?comID=<%= com.getComID() %>" class="btn btn-primary">수정</a>
							<a href="communityDelete?comID=<%= com.getComID() %>" class="btn btn-primary" onclick="return confirm('이 게시물을 삭제하시겠습니까?')">삭제</a>
						<%
							}
						%>
					</td>
