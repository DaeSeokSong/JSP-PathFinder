...
<html>
	<%
		...
		ArrayList<TipDTO> tipList = new TipDAO().getList(pageNumber);
	%>
<head>
			...
			<tbody>
				<%
					for (int i = 0; i < tipList.size(); i++) {
						TipDTO tip = tipList.get(i);
				%>
				<tr>
					<td><%=tip.getTipLang()%></td>
					<td style="text-align: left;"><a href="acatipShow.jsp?tipID=<%=tip.getTipID()%>">
				<%
					for(int j = 0; j < tip.getTipLevel(); j++) {
				%>
				...
				<tr>
					<td colspan="5">
						<a href="acatipWrite.jsp" class="btn btn-primary pull-right" type="submit">글쓰기</a>
						<ul class="pagination" style="margin: 0 auto;">
						<%
							int startPage = (Integer.parseInt(pageNumber) / 10) * 10 + 1;
							if(Integer.parseInt(pageNumber) % 10 == 0) startPage -= 10;
							
							int targetPage = new TipDAO().targetPage(pageNumber);
							
							if(startPage != 1) {
						%>
							<li><a href="acatip.jsp?pageNumber=<%= startPage - 10 %>"><span class="glyphicon glyphicon-chevron-left"></span></a></li>
						<%
							} else {
						%>
						...
						%>
							<li><a href="acatip.jsp?pageNumber=<%= i %>"><%= i %></a></li>
						<%
							}
						%>
							<li class="active"><a href="acatip.jsp?pageNumber=<%= pageNumber %>"><%= pageNumber %></a></li>
						<%
						...
						%>
							<li><a href="acatip.jsp?pageNumber=<%= startPage + 10 %>"><span class="glyphicon glyphicon-chevron-right"></span></a></li>
						<%
							} else {
						%>
